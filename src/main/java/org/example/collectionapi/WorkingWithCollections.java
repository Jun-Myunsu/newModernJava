package org.example.collectionapi;

import static java.util.Map.entry;
import static org.example.stream06.GroupingTransactions.transactions;
...
//        for(String map : ageOfFriends.keySet()) {
//            System.out.println(map + " is " + ageOfFriends.get(map) + " years old");
//        }
